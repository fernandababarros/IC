...
###### GRÁFICO
p=11
pdf("reg-graf.pdf", width=12, height=12, pointsize=24)
par(mar=c(5,1,3,1))
plot(1, type="n", xlab="",
...
points(x=0:(p-1) + 0.2, y=coef_fit_MCAR, col="gray50", pch=1, cex=1.0)
segments(x0=0.2, x1=0.2, y0=ic_completo_MCAR[1,2], y1=ic_completo_MCAR[1,3],
         col="gray50", lwd=3, lty=1, pch=1)
...
points(x=0:(p-1) + 0.4, y=coef_fit_MAR_genero, col="gray50", pch=15, cex=1.0)
segments(x0=0.4, x1=0.4, y0=ic_completo_MAR_genero[1,2], y1=ic_completo_MAR_genero[1,3],
         col="gray50", lwd=3, lty=1, pch=15)
...
points(x=0:(p-1) + 0.6, y=coef_fit_MAR_ensino, col="gray50", pch=18, cex=1.0)
...
points(x=0:(p-1) + 0.8, y=coef_fit_MNAR, col="gray50", pch=17, cex=1.0)
segments(x0=0.8, x1=0.8, y0=ic_completo_MNAR[1,2], y1=ic_completo_MNAR[1,3],
         col="gray50", lwd=3, lty=1, pch=17)
...
text(0.4, -3.2, "Intercepto", xpd=NA, srt=90, cex=0.75)
text(1.4, -3.2, "Gênero\nMasculino", xpd=NA, srt=90, cex=0.75)
text(2.4, -3.2, "Idade", xpd=NA, srt=90, cex=0.75)
text(3.4, -3.6, "Estado Civil\nMorando Juntos", xpd=NA, srt=90, cex=0.75)
text(4.4, -3.3, "Estado Civil\nOutros", xpd=NA, srt=90, cex=0.75)
text(5.4, -3.5, "Anos de\nEscolaridade", xpd=NA, srt=90, cex=0.75)
text(6.4, -3.2, "Etnia\nHispânico", xpd=NA, srt=90, cex=0.75)
text(7.4, -3.2, "Etnia\nNegro", xpd=NA, srt=90, cex=0.75)
text(8.4, -3.2, "Etnia\nOutros", xpd=NA, srt=90, cex=0.75)
text(9.4, -3.5, "Ensino Médio", xpd=NA, srt=90, cex=0.75)
text(10.4, -3.6, "Ensino Superior", xpd=NA, srt=90, cex=0.75)

legend(x=6.5,y=11.3,
       c("Original", "Perda Completamente Aleatória", "Perda Aleatória - Gênero", "Perda Aleatória - Ensino", "Perda Não Aleatória"),
       col=c("black", "gray50", "gray50","gray50","gray50"),
       pch=c(20,1,15,18,17), cex=0.8)

dev.off()


###TESTE GRÁFICO MAIS ESPAÇADO
#p=11
#v=seq(from=0, len=p, by=1.5)
#par(mar=c(5,1,3,1))
#plot(1, type="n", xlab="",
#     ylab="", xlim=c(0,11), ylim=c(-1.60,11.10),
#     xaxt="n", yaxt="n",
...
#
#points(x=0:v, y=coef_fit_orig, col="black", pch=20, cex=1.0)
#segments(x0=0, x1=0, y0=ic_completo_orig[1,2], y1=ic_completo_orig[1,3],
#         col="black", lwd=3, lty=1, pch=20)
#segments(x0=1, x1=1, y0=ic_completo_orig[2,2], y1=ic_completo_orig[2,3],
#         col="black", lwd=3, lty=1, pch=20)
...
#         col="black", lwd=3, lty=1, pch=20)
#
#points(x=0:v + 0.2, y=coef_fit_MCAR, col="gray50", pch=1, cex=1.0)
#segments(x0=0.2, x1=0.2, y0=ic_completo_MCAR[1,2], y1=ic_completo_MCAR[1,3],
#         col="gray50", lwd=3, lty=1, pch=1)
#segments(x0=1.2, x1=1.2, y0=ic_completo_MCAR[2,2], y1=ic_completo_MCAR[2,3],
#         col="gray50", lwd=3, lty=1, pch=1)
...
#         col="gray50", lwd=3, lty=1, pch=1)
#
#points(x=0:v + 0.4, y=coef_fit_MAR_genero, col="gray50", pch=15, cex=1.0)
#segments(x0=0.4, x1=0.4, y0=ic_completo_MAR_genero[1,2], y1=ic_completo_MAR_genero[1,3],
#         col="gray50", lwd=3, lty=1, pch=15)
#segments(x0=1.4, x1=1.4, y0=ic_completo_MAR_genero[2,2], y1=ic_completo_MAR_genero[2,3],
#         col="gray50", lwd=3, lty=1, pch=15)
...
#         col="gray50", lwd=3, lty=1, pch=15)
#
#points(x=0:v + 0.6, y=coef_fit_MAR_ensino, col="gray50", pch=18, cex=1.0)
#segments(x0=0.6, x1=0.6, y0=ic_completo_MAR_ensino[1,2], y1=ic_completo_MAR_ensino[1,3],
#         col="gray50", lwd=3, lty=1, pch=18)
#segments(x0=1.6, x1=1.6, y0=ic_completo_MAR_ensino[2,2], y1=ic_completo_MAR_ensino[2,3],
#         col="gray50", lwd=3, lty=1, pch=18)
...
#         col="gray50", lwd=3, lty=1, pch=18)
#
#points(x=0:v + 0.8, y=coef_fit_MNAR, col="gray50", pch=17, cex=1.0)
#segments(x0=0.8, x1=0.8, y0=ic_completo_MNAR[1,2], y1=ic_completo_MNAR[1,3],
#         col="gray50", lwd=3, lty=1, pch=17)
#segments(x0=1.8, x1=1.8, y0=ic_completo_MNAR[2,2], y1=ic_completo_MNAR[2,3],
#         col="gray50", lwd=3, lty=1, pch=17)
