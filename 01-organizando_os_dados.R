...
dados_MCAR[,6] = ifelse(random_MCAR, NA, dados$Income)
...
dados_MAR_fem[,7] = ifelse(random_MAR_fem, NA, dados$Income)
...
dados_MAR_masc[,7] = ifelse(random_MAR_masc, NA, dados$Income)
...
dados_MAR_ef[,7] = ifelse(random_MAR_ef, NA, dados$Income)
...
dados_MAR_em[,7] = ifelse(random_MAR_em, NA, dados$Income)
...
dados_MAR_es[,7] = ifelse(random_MAR_es, NA, dados$Income)
