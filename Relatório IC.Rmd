...
Para realizar a imputação dos dados utilizamos o banco de dados *US Term Life insurance* do pacote *CASdatasets* disponível no software R. As imputações e os resultados foram obtidos utilizando o software estatístico R. O banco de dados possui 18 variáveis com 500 observações, como pode ser visto abaixo.
...
Estado Civil (estado civil do entrevistado, sendo 1 para casado, 2 se mora com o parceiro e 0 para outros);
